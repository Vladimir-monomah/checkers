...
public class AboutBox: Form {
  public AboutBox () {
    ...
    AddLabel(new Point(170, 8), new Size(128, 16), "Проект");

    // Create the labels for the license message
    AddLabel (new Point(170, 38), new Size(128, 16), "Студента 547 группы ");
    
    AddLabel (new Point(170, 68), new Size(128, 16), "Быкова Владимира");
